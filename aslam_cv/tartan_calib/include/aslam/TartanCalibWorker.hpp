...
namespace aslam
{
    ...
    {
        public:  
            TartanCalibWorker(const C* camera,aslam::cameras::GridDetector gd,const std::vector<aslam::cameras::GridCalibrationTargetObservation>& obslist, const  Eigen::MatrixXd & fovs, const  Eigen::MatrixXd & poses, const  Eigen::MatrixXd & resolutions, const bool verbose)
            : obslist_(obslist),
            gd_(gd),
            camera_(camera),
            fovs_(fovs),
